...
- <img src="https://cdn.simpleicons.org/docker/0db7ed" height="14"/> [Docker](https://github.com/friendlygeorge/docker-mcp-server) - Agent-focused Docker MCP server with 50 tools: health checks, auto-restart, compose lifecycle, fleet monitoring, log streaming. Built for agents that need containers to stay running.
